...
@Entity
@Table(name = "admin_division_collectors")
public class AdminDivisionCollector {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "admin_division_id", nullable = false)
    ...
    public Long getAdminDivisionId() { return adminDivisionId; }
    public void setAdminDivisionId(Long adminDivisionId) { this.adminDivisionId = adminDivisionId; }
